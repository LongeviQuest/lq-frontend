...
export const OldestLivingPeopleEmbedPage = () => {
  ...
  return (
    <div className="results">
      <TableEmbed
        ...
        title="Oldest Living People"
        link="https://longeviquest.com/atlas/living?validation=validated&finalValidationDateValue=&living=living"
        isLoaded={!isFetching}
      />
    </div>
  );
